    ...
    export class Endpoint extends pb_1.Message {
        ...
        constructor(data?: any[] | {
            ...
            if (!Array.isArray(data) && typeof data == "object") {
                ...
                if ("addressIpv6" in data && data.addressIpv6 != undefined) {
                    this.addressIpv6 = data.addressIpv6;
                }
            }
        }
        get address() {
        ...
        static fromObject(data: {
            ...
            if (data.addressIpv6 != null) {
                message.addressIpv6 = data.addressIpv6;
            }
            return message;
        }
        toObject() {
            ...
            if (this.addressIpv6 != null) {
                data.addressIpv6 = this.addressIpv6;
            }
            return data;
        }
        ...
        serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
            ...
            if (this.addressIpv6.length)
                writer.writeBytes(4, this.addressIpv6);
            if (!w)
            ...
            while (reader.nextField()) {
                ...
                switch (reader.getFieldNumber()) {
                    ...
                    case 3:
                        ...
                        break;
                    case 4:
                        message.addressIpv6 = reader.readBytes();
                        break;
