...
export namespace protocol {
    ...
    export class AssetIssueList extends pb_1.Message {
        ...
        get assetIssue() {
            return pb_1.Message.getRepeatedWrapperField(this, dependency_2.protocol.AssetIssueContract, 1) as dependency_2.protocol.AssetIssueContract[];
        }
        ...
        static fromObject(data: {
            ...
            if (data.assetIssue != null) {
                message.assetIssue = data.assetIssue.map(item => dependency_2.protocol.AssetIssueContract.fromObject(item));
            }
            return message;
        }
        toObject() {
            ...
            if (this.assetIssue != null) {
                data.assetIssue = this.assetIssue.map((item: dependency_2.protocol.AssetIssueContract) => item.toObject());
            }
            return data;
        }
        serialize(): Uint8Array;
        ...
        serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
            ...
            if (this.assetIssue.length)
                writer.writeRepeatedMessage(1, this.assetIssue, (item: dependency_2.protocol.AssetIssueContract) => item.serialize(writer));
            if (!w)
                return writer.getResultBuffer();
        }
        static deserialize(bytes: Uint8Array | pb_1.BinaryReader): AssetIssueList {
            ...
            while (reader.nextField()) {
                ...
                switch (reader.getFieldNumber()) {
                    case 1:
                        reader.readMessage(message.assetIssue, () => pb_1.Message.addToRepeatedWrapperField(message, 1, dependency_2.protocol.AssetIssueContract.deserialize(reader), dependency_2.protocol.AssetIssueContract));
                        break;
                    default: reader.skipField();
                }
            }
    ...
    export abstract class UnimplementedWalletService {
        static definition = {
            ...
            UpdateAccount: {
                ...
                requestStream: false,
                responseStream: false,
                requestSerialize: (message: dependency_3.protocol.AccountUpdateContract) => Buffer.from(message.serialize()),
                requestDeserialize: (bytes: Buffer) => dependency_3.protocol.AccountUpdateContract.deserialize(new Uint8Array(bytes)),
                responseSerialize: (message: dependency_1.protocol.Transaction) => Buffer.from(message.serialize()),
                responseDeserialize: (bytes: Buffer) => dependency_1.protocol.Transaction.deserialize(new Uint8Array(bytes))
            },
            SetAccountId: {
                ...
                requestStream: false,
                responseStream: false,
                requestSerialize: (message: dependency_3.protocol.SetAccountIdContract) => Buffer.from(message.serialize()),
                requestDeserialize: (bytes: Buffer) => dependency_3.protocol.SetAccountIdContract.deserialize(new Uint8Array(bytes)),
                responseSerialize: (message: dependency_1.protocol.Transaction) => Buffer.from(message.serialize()),
                responseDeserialize: (bytes: Buffer) => dependency_1.protocol.Transaction.deserialize(new Uint8Array(bytes))
            },
            UpdateAccount2: {
            ...
            CreateAssetIssue: {
                ...
                requestStream: false,
                responseStream: false,
                requestSerialize: (message: dependency_2.protocol.AssetIssueContract) => Buffer.from(message.serialize()),
                requestDeserialize: (bytes: Buffer) => dependency_2.protocol.AssetIssueContract.deserialize(new Uint8Array(bytes)),
                responseSerialize: (message: dependency_1.protocol.Transaction) => Buffer.from(message.serialize()),
                responseDeserialize: (bytes: Buffer) => dependency_1.protocol.Transaction.deserialize(new Uint8Array(bytes))
            },
            CreateAssetIssue2: {
            ...
            CreateAccount: {
                ...
                requestStream: false,
                responseStream: false,
                requestSerialize: (message: dependency_3.protocol.AccountCreateContract) => Buffer.from(message.serialize()),
                requestDeserialize: (bytes: Buffer) => dependency_3.protocol.AccountCreateContract.deserialize(new Uint8Array(bytes)),
                responseSerialize: (message: dependency_1.protocol.Transaction) => Buffer.from(message.serialize()),
                responseDeserialize: (bytes: Buffer) => dependency_1.protocol.Transaction.deserialize(new Uint8Array(bytes))
            },
            CreateAccount2: {
            ...
            TransferAsset: {
                ...
                requestStream: false,
                responseStream: false,
                requestSerialize: (message: dependency_2.protocol.TransferAssetContract) => Buffer.from(message.serialize()),
                requestDeserialize: (bytes: Buffer) => dependency_2.protocol.TransferAssetContract.deserialize(new Uint8Array(bytes)),
                responseSerialize: (message: dependency_1.protocol.Transaction) => Buffer.from(message.serialize()),
                responseDeserialize: (bytes: Buffer) => dependency_1.protocol.Transaction.deserialize(new Uint8Array(bytes))
            },
            TransferAsset2: {
            ...
            ParticipateAssetIssue: {
                ...
                requestStream: false,
                responseStream: false,
                requestSerialize: (message: dependency_2.protocol.ParticipateAssetIssueContract) => Buffer.from(message.serialize()),
                requestDeserialize: (bytes: Buffer) => dependency_2.protocol.ParticipateAssetIssueContract.deserialize(new Uint8Array(bytes)),
                responseSerialize: (message: dependency_1.protocol.Transaction) => Buffer.from(message.serialize()),
                responseDeserialize: (bytes: Buffer) => dependency_1.protocol.Transaction.deserialize(new Uint8Array(bytes))
            },
            ...
            UnfreezeAsset: {
                ...
                requestStream: false,
                responseStream: false,
                requestSerialize: (message: dependency_2.protocol.UnfreezeAssetContract) => Buffer.from(message.serialize()),
                requestDeserialize: (bytes: Buffer) => dependency_2.protocol.UnfreezeAssetContract.deserialize(new Uint8Array(bytes)),
                responseSerialize: (message: dependency_1.protocol.Transaction) => Buffer.from(message.serialize()),
                responseDeserialize: (bytes: Buffer) => dependency_1.protocol.Transaction.deserialize(new Uint8Array(bytes))
            },
            UnfreezeAsset2: {
            ...
            UpdateAsset: {
                ...
                requestStream: false,
                responseStream: false,
                requestSerialize: (message: dependency_2.protocol.UpdateAssetContract) => Buffer.from(message.serialize()),
                requestDeserialize: (bytes: Buffer) => dependency_2.protocol.UpdateAssetContract.deserialize(new Uint8Array(bytes)),
                responseSerialize: (message: dependency_1.protocol.Transaction) => Buffer.from(message.serialize()),
                responseDeserialize: (bytes: Buffer) => dependency_1.protocol.Transaction.deserialize(new Uint8Array(bytes))
            },
            UpdateAsset2: {
            ...
            GetAssetIssueByName: {
                ...
                requestSerialize: (message: BytesMessage) => Buffer.from(message.serialize()),
                requestDeserialize: (bytes: Buffer) => BytesMessage.deserialize(new Uint8Array(bytes)),
                responseSerialize: (message: dependency_2.protocol.AssetIssueContract) => Buffer.from(message.serialize()),
                responseDeserialize: (bytes: Buffer) => dependency_2.protocol.AssetIssueContract.deserialize(new Uint8Array(bytes))
            },
            ...
            GetBlockByLimitNext: {
                ...
                responseSerialize: (message: BlockList) => Buffer.from(message.serialize()),
                responseDeserialize: (bytes: Buffer) => BlockList.deserialize(new Uint8Array(bytes))
            },
            ...
            GetPaginatedNowWitnessList: {
                path: "/protocol.Wallet/GetPaginatedNowWitnessList",
                requestStream: false,
                responseStream: false,
            ...
            AccountPermissionUpdate: {
                ...
                requestStream: false,
                responseStream: false,
                requestSerialize: (message: dependency_3.protocol.AccountPermissionUpdateContract) => Buffer.from(message.serialize()),
                requestDeserialize: (bytes: Buffer) => dependency_3.protocol.AccountPermissionUpdateContract.deserialize(new Uint8Array(bytes)),
                responseSerialize: (message: TransactionExtention) => Buffer.from(message.serialize()),
                responseDeserialize: (bytes: Buffer) => TransactionExtention.deserialize(new Uint8Array(bytes))
            },
    ...
    export class WalletClient extends grpc_1.makeGenericClientConstructor(UnimplementedWalletService.definition, "Wallet", {}) {
        ...
        CreateTransaction: GrpcUnaryServiceInterface<dependency_5.protocol.TransferContract, dependency_1.protocol.Transaction> = (message: dependency_5.protocol.TransferContract, metadata: grpc_1.Metadata | grpc_1.CallOptions | grpc_1.requestCallback<dependency_1.protocol.Transaction>, options?: grpc_1.CallOptions | grpc_1.requestCallback<dependency_1.protocol.Transaction>, callback?: grpc_1.requestCallback<dependency_1.protocol.Transaction>): grpc_1.ClientUnaryCall => {
        ...
        UpdateAccount: GrpcUnaryServiceInterface<dependency_3.protocol.AccountUpdateContract, dependency_1.protocol.Transaction> = (message: dependency_3.protocol.AccountUpdateContract, metadata: grpc_1.Metadata | grpc_1.CallOptions | grpc_1.requestCallback<dependency_1.protocol.Transaction>, options?: grpc_1.CallOptions | grpc_1.requestCallback<dependency_1.protocol.Transaction>, callback?: grpc_1.requestCallback<dependency_1.protocol.Transaction>): grpc_1.ClientUnaryCall => {
            return super.UpdateAccount(message, metadata, options, callback);
        };
        SetAccountId: GrpcUnaryServiceInterface<dependency_3.protocol.SetAccountIdContract, dependency_1.protocol.Transaction> = (message: dependency_3.protocol.SetAccountIdContract, metadata: grpc_1.Metadata | grpc_1.CallOptions | grpc_1.requestCallback<dependency_1.protocol.Transaction>, options?: grpc_1.CallOptions | grpc_1.requestCallback<dependency_1.protocol.Transaction>, callback?: grpc_1.requestCallback<dependency_1.protocol.Transaction>): grpc_1.ClientUnaryCall => {
            return super.SetAccountId(message, metadata, options, callback);
        };
        UpdateAccount2: GrpcUnaryServiceInterface<dependency_3.protocol.AccountUpdateContract, TransactionExtention> = (message: dependency_3.protocol.AccountUpdateContract, metadata: grpc_1.Metadata | grpc_1.CallOptions | grpc_1.requestCallback<TransactionExtention>, options?: grpc_1.CallOptions | grpc_1.requestCallback<TransactionExtention>, callback?: grpc_1.requestCallback<TransactionExtention>): grpc_1.ClientUnaryCall => {
            return super.UpdateAccount2(message, metadata, options, callback);
        };
        VoteWitnessAccount: GrpcUnaryServiceInterface<dependency_4.protocol.VoteWitnessContract, dependency_1.protocol.Transaction> = (message: dependency_4.protocol.VoteWitnessContract, metadata: grpc_1.Metadata | grpc_1.CallOptions | grpc_1.requestCallback<dependency_1.protocol.Transaction>, options?: grpc_1.CallOptions | grpc_1.requestCallback<dependency_1.protocol.Transaction>, callback?: grpc_1.requestCallback<dependency_1.protocol.Transaction>): grpc_1.ClientUnaryCall => {
            return super.VoteWitnessAccount(message, metadata, options, callback);
        };
        ...
        CreateAssetIssue: GrpcUnaryServiceInterface<dependency_2.protocol.AssetIssueContract, dependency_1.protocol.Transaction> = (message: dependency_2.protocol.AssetIssueContract, metadata: grpc_1.Metadata | grpc_1.CallOptions | grpc_1.requestCallback<dependency_1.protocol.Transaction>, options?: grpc_1.CallOptions | grpc_1.requestCallback<dependency_1.protocol.Transaction>, callback?: grpc_1.requestCallback<dependency_1.protocol.Transaction>): grpc_1.ClientUnaryCall => {
            return super.CreateAssetIssue(message, metadata, options, callback);
        };
        CreateAssetIssue2: GrpcUnaryServiceInterface<dependency_2.protocol.AssetIssueContract, TransactionExtention> = (message: dependency_2.protocol.AssetIssueContract, metadata: grpc_1.Metadata | grpc_1.CallOptions | grpc_1.requestCallback<TransactionExtention>, options?: grpc_1.CallOptions | grpc_1.requestCallback<TransactionExtention>, callback?: grpc_1.requestCallback<TransactionExtention>): grpc_1.ClientUnaryCall => {
            return super.CreateAssetIssue2(message, metadata, options, callback);
        };
        UpdateWitness: GrpcUnaryServiceInterface<dependency_4.protocol.WitnessUpdateContract, dependency_1.protocol.Transaction> = (message: dependency_4.protocol.WitnessUpdateContract, metadata: grpc_1.Metadata | grpc_1.CallOptions | grpc_1.requestCallback<dependency_1.protocol.Transaction>, options?: grpc_1.CallOptions | grpc_1.requestCallback<dependency_1.protocol.Transaction>, callback?: grpc_1.requestCallback<dependency_1.protocol.Transaction>): grpc_1.ClientUnaryCall => {
            return super.UpdateWitness(message, metadata, options, callback);
        };
        ...
        CreateAccount: GrpcUnaryServiceInterface<dependency_3.protocol.AccountCreateContract, dependency_1.protocol.Transaction> = (message: dependency_3.protocol.AccountCreateContract, metadata: grpc_1.Metadata | grpc_1.CallOptions | grpc_1.requestCallback<dependency_1.protocol.Transaction>, options?: grpc_1.CallOptions | grpc_1.requestCallback<dependency_1.protocol.Transaction>, callback?: grpc_1.requestCallback<dependency_1.protocol.Transaction>): grpc_1.ClientUnaryCall => {
            return super.CreateAccount(message, metadata, options, callback);
        };
        CreateAccount2: GrpcUnaryServiceInterface<dependency_3.protocol.AccountCreateContract, TransactionExtention> = (message: dependency_3.protocol.AccountCreateContract, metadata: grpc_1.Metadata | grpc_1.CallOptions | grpc_1.requestCallback<TransactionExtention>, options?: grpc_1.CallOptions | grpc_1.requestCallback<TransactionExtention>, callback?: grpc_1.requestCallback<TransactionExtention>): grpc_1.ClientUnaryCall => {
            return super.CreateAccount2(message, metadata, options, callback);
        };
        CreateWitness: GrpcUnaryServiceInterface<dependency_4.protocol.WitnessCreateContract, dependency_1.protocol.Transaction> = (message: dependency_4.protocol.WitnessCreateContract, metadata: grpc_1.Metadata | grpc_1.CallOptions | grpc_1.requestCallback<dependency_1.protocol.Transaction>, options?: grpc_1.CallOptions | grpc_1.requestCallback<dependency_1.protocol.Transaction>, callback?: grpc_1.requestCallback<dependency_1.protocol.Transaction>): grpc_1.ClientUnaryCall => {
            return super.CreateWitness(message, metadata, options, callback);
        };
        ...
        TransferAsset: GrpcUnaryServiceInterface<dependency_2.protocol.TransferAssetContract, dependency_1.protocol.Transaction> = (message: dependency_2.protocol.TransferAssetContract, metadata: grpc_1.Metadata | grpc_1.CallOptions | grpc_1.requestCallback<dependency_1.protocol.Transaction>, options?: grpc_1.CallOptions | grpc_1.requestCallback<dependency_1.protocol.Transaction>, callback?: grpc_1.requestCallback<dependency_1.protocol.Transaction>): grpc_1.ClientUnaryCall => {
            return super.TransferAsset(message, metadata, options, callback);
        };
        TransferAsset2: GrpcUnaryServiceInterface<dependency_2.protocol.TransferAssetContract, TransactionExtention> = (message: dependency_2.protocol.TransferAssetContract, metadata: grpc_1.Metadata | grpc_1.CallOptions | grpc_1.requestCallback<TransactionExtention>, options?: grpc_1.CallOptions | grpc_1.requestCallback<TransactionExtention>, callback?: grpc_1.requestCallback<TransactionExtention>): grpc_1.ClientUnaryCall => {
            return super.TransferAsset2(message, metadata, options, callback);
        };
        ParticipateAssetIssue: GrpcUnaryServiceInterface<dependency_2.protocol.ParticipateAssetIssueContract, dependency_1.protocol.Transaction> = (message: dependency_2.protocol.ParticipateAssetIssueContract, metadata: grpc_1.Metadata | grpc_1.CallOptions | grpc_1.requestCallback<dependency_1.protocol.Transaction>, options?: grpc_1.CallOptions | grpc_1.requestCallback<dependency_1.protocol.Transaction>, callback?: grpc_1.requestCallback<dependency_1.protocol.Transaction>): grpc_1.ClientUnaryCall => {
            return super.ParticipateAssetIssue(message, metadata, options, callback);
        };
        ParticipateAssetIssue2: GrpcUnaryServiceInterface<dependency_2.protocol.ParticipateAssetIssueContract, TransactionExtention> = (message: dependency_2.protocol.ParticipateAssetIssueContract, metadata: grpc_1.Metadata | grpc_1.CallOptions | grpc_1.requestCallback<TransactionExtention>, options?: grpc_1.CallOptions | grpc_1.requestCallback<TransactionExtention>, callback?: grpc_1.requestCallback<TransactionExtention>): grpc_1.ClientUnaryCall => {
            return super.ParticipateAssetIssue2(message, metadata, options, callback);
        };
        FreezeBalance: GrpcUnaryServiceInterface<dependency_5.protocol.FreezeBalanceContract, dependency_1.protocol.Transaction> = (message: dependency_5.protocol.FreezeBalanceContract, metadata: grpc_1.Metadata | grpc_1.CallOptions | grpc_1.requestCallback<dependency_1.protocol.Transaction>, options?: grpc_1.CallOptions | grpc_1.requestCallback<dependency_1.protocol.Transaction>, callback?: grpc_1.requestCallback<dependency_1.protocol.Transaction>): grpc_1.ClientUnaryCall => {
            return super.FreezeBalance(message, metadata, options, callback);
        };
        ...
        UnfreezeBalance: GrpcUnaryServiceInterface<dependency_5.protocol.UnfreezeBalanceContract, dependency_1.protocol.Transaction> = (message: dependency_5.protocol.UnfreezeBalanceContract, metadata: grpc_1.Metadata | grpc_1.CallOptions | grpc_1.requestCallback<dependency_1.protocol.Transaction>, options?: grpc_1.CallOptions | grpc_1.requestCallback<dependency_1.protocol.Transaction>, callback?: grpc_1.requestCallback<dependency_1.protocol.Transaction>): grpc_1.ClientUnaryCall => {
            return super.UnfreezeBalance(message, metadata, options, callback);
        };
        ...
        UnfreezeAsset: GrpcUnaryServiceInterface<dependency_2.protocol.UnfreezeAssetContract, dependency_1.protocol.Transaction> = (message: dependency_2.protocol.UnfreezeAssetContract, metadata: grpc_1.Metadata | grpc_1.CallOptions | grpc_1.requestCallback<dependency_1.protocol.Transaction>, options?: grpc_1.CallOptions | grpc_1.requestCallback<dependency_1.protocol.Transaction>, callback?: grpc_1.requestCallback<dependency_1.protocol.Transaction>): grpc_1.ClientUnaryCall => {
            return super.UnfreezeAsset(message, metadata, options, callback);
        };
        UnfreezeAsset2: GrpcUnaryServiceInterface<dependency_2.protocol.UnfreezeAssetContract, TransactionExtention> = (message: dependency_2.protocol.UnfreezeAssetContract, metadata: grpc_1.Metadata | grpc_1.CallOptions | grpc_1.requestCallback<TransactionExtention>, options?: grpc_1.CallOptions | grpc_1.requestCallback<TransactionExtention>, callback?: grpc_1.requestCallback<TransactionExtention>): grpc_1.ClientUnaryCall => {
            return super.UnfreezeAsset2(message, metadata, options, callback);
        };
        WithdrawBalance: GrpcUnaryServiceInterface<dependency_5.protocol.WithdrawBalanceContract, dependency_1.protocol.Transaction> = (message: dependency_5.protocol.WithdrawBalanceContract, metadata: grpc_1.Metadata | grpc_1.CallOptions | grpc_1.requestCallback<dependency_1.protocol.Transaction>, options?: grpc_1.CallOptions | grpc_1.requestCallback<dependency_1.protocol.Transaction>, callback?: grpc_1.requestCallback<dependency_1.protocol.Transaction>): grpc_1.ClientUnaryCall => {
            return super.WithdrawBalance(message, metadata, options, callback);
        };
        ...
        UpdateAsset: GrpcUnaryServiceInterface<dependency_2.protocol.UpdateAssetContract, dependency_1.protocol.Transaction> = (message: dependency_2.protocol.UpdateAssetContract, metadata: grpc_1.Metadata | grpc_1.CallOptions | grpc_1.requestCallback<dependency_1.protocol.Transaction>, options?: grpc_1.CallOptions | grpc_1.requestCallback<dependency_1.protocol.Transaction>, callback?: grpc_1.requestCallback<dependency_1.protocol.Transaction>): grpc_1.ClientUnaryCall => {
            return super.UpdateAsset(message, metadata, options, callback);
        };
        UpdateAsset2: GrpcUnaryServiceInterface<dependency_2.protocol.UpdateAssetContract, TransactionExtention> = (message: dependency_2.protocol.UpdateAssetContract, metadata: grpc_1.Metadata | grpc_1.CallOptions | grpc_1.requestCallback<TransactionExtention>, options?: grpc_1.CallOptions | grpc_1.requestCallback<TransactionExtention>, callback?: grpc_1.requestCallback<TransactionExtention>): grpc_1.ClientUnaryCall => {
        ...
        GetAssetIssueByName: GrpcUnaryServiceInterface<BytesMessage, dependency_2.protocol.AssetIssueContract> = (message: BytesMessage, metadata: grpc_1.Metadata | grpc_1.CallOptions | grpc_1.requestCallback<dependency_2.protocol.AssetIssueContract>, options?: grpc_1.CallOptions | grpc_1.requestCallback<dependency_2.protocol.AssetIssueContract>, callback?: grpc_1.requestCallback<dependency_2.protocol.AssetIssueContract>): grpc_1.ClientUnaryCall => {
        ...
        GetAssetIssueById: GrpcUnaryServiceInterface<BytesMessage, dependency_2.protocol.AssetIssueContract> = (message: BytesMessage, metadata: grpc_1.Metadata | grpc_1.CallOptions | grpc_1.requestCallback<dependency_2.protocol.AssetIssueContract>, options?: grpc_1.CallOptions | grpc_1.requestCallback<dependency_2.protocol.AssetIssueContract>, callback?: grpc_1.requestCallback<dependency_2.protocol.AssetIssueContract>): grpc_1.ClientUnaryCall => {
        ...
        GetBlockByLimitNext: GrpcUnaryServiceInterface<BlockLimit, BlockList> = (message: BlockLimit, metadata: grpc_1.Metadata | grpc_1.CallOptions | grpc_1.requestCallback<BlockList>, options?: grpc_1.CallOptions | grpc_1.requestCallback<BlockList>, callback?: grpc_1.requestCallback<BlockList>): grpc_1.ClientUnaryCall => {
            return super.GetBlockByLimitNext(message, metadata, options, callback);
        };
        ...
        GetBlockByLatestNum: GrpcUnaryServiceInterface<NumberMessage, BlockList> = (message: NumberMessage, metadata: grpc_1.Metadata | grpc_1.CallOptions | grpc_1.requestCallback<BlockList>, options?: grpc_1.CallOptions | grpc_1.requestCallback<BlockList>, callback?: grpc_1.requestCallback<BlockList>): grpc_1.ClientUnaryCall => {
            return super.GetBlockByLatestNum(message, metadata, options, callback);
        };
        ...
        GetPaginatedNowWitnessList: GrpcUnaryServiceInterface<PaginatedMessage, WitnessList> = (message: PaginatedMessage, metadata: grpc_1.Metadata | grpc_1.CallOptions | grpc_1.requestCallback<WitnessList>, options?: grpc_1.CallOptions | grpc_1.requestCallback<WitnessList>, callback?: grpc_1.requestCallback<WitnessList>): grpc_1.ClientUnaryCall => {
            return super.GetPaginatedNowWitnessList(message, metadata, options, callback);
        };
        ...
        AccountPermissionUpdate: GrpcUnaryServiceInterface<dependency_3.protocol.AccountPermissionUpdateContract, TransactionExtention> = (message: dependency_3.protocol.AccountPermissionUpdateContract, metadata: grpc_1.Metadata | grpc_1.CallOptions | grpc_1.requestCallback<TransactionExtention>, options?: grpc_1.CallOptions | grpc_1.requestCallback<TransactionExtention>, callback?: grpc_1.requestCallback<TransactionExtention>): grpc_1.ClientUnaryCall => {
    ...
    export abstract class UnimplementedWalletSolidityService {
        static definition = {
            ...
            GetPaginatedNowWitnessList: {
                path: "/protocol.WalletSolidity/GetPaginatedNowWitnessList",
                requestStream: false,
                responseStream: false,
                requestSerialize: (message: PaginatedMessage) => Buffer.from(message.serialize()),
                requestDeserialize: (bytes: Buffer) => PaginatedMessage.deserialize(new Uint8Array(bytes)),
    ...
    export class WalletSolidityClient extends grpc_1.makeGenericClientConstructor(UnimplementedWalletSolidityService.definition, "WalletSolidity", {}) {
        constructor(address: string, credentials: grpc_1.ChannelCredentials, options?: Partial<grpc_1.ChannelOptions>) {
            super(address, credentials, options);
        }
        GetAccount: GrpcUnaryServiceInterface<dependency_1.protocol.Account, dependency_1.protocol.Account> = (message: dependency_1.protocol.Account, metadata: grpc_1.Metadata | grpc_1.CallOptions | grpc_1.requestCallback<dependency_1.protocol.Account>, options?: grpc_1.CallOptions | grpc_1.requestCallback<dependency_1.protocol.Account>, callback?: grpc_1.requestCallback<dependency_1.protocol.Account>): grpc_1.ClientUnaryCall => {
    ...
    export abstract class UnimplementedWalletExtensionService {
        static definition = {
            GetTransactionsFromThis: {
                ...
                responseSerialize: (message: TransactionList) => Buffer.from(message.serialize()),
                responseDeserialize: (bytes: Buffer) => TransactionList.deserialize(new Uint8Array(bytes))
            },
    ...
    export class WalletExtensionClient extends grpc_1.makeGenericClientConstructor(UnimplementedWalletExtensionService.definition, "WalletExtension", {}) {
        ...
        GetTransactionsFromThis: GrpcUnaryServiceInterface<AccountPaginated, TransactionList> = (message: AccountPaginated, metadata: grpc_1.Metadata | grpc_1.CallOptions | grpc_1.requestCallback<TransactionList>, options?: grpc_1.CallOptions | grpc_1.requestCallback<TransactionList>, callback?: grpc_1.requestCallback<TransactionList>): grpc_1.ClientUnaryCall => {
            return super.GetTransactionsFromThis(message, metadata, options, callback);
        };
        ...
        GetTransactionsToThis: GrpcUnaryServiceInterface<AccountPaginated, TransactionList> = (message: AccountPaginated, metadata: grpc_1.Metadata | grpc_1.CallOptions | grpc_1.requestCallback<TransactionList>, options?: grpc_1.CallOptions | grpc_1.requestCallback<TransactionList>, callback?: grpc_1.requestCallback<TransactionList>): grpc_1.ClientUnaryCall => {
            return super.GetTransactionsToThis(message, metadata, options, callback);
        };
